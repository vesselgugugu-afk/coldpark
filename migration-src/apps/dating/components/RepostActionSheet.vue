...
const loadChatList = async () => {
  ...
  try {
    const chats = bridge.hasSdk() ? await bridge.dbList('matches') : await db.dating_chats.toArray()
    const profiles = bridge.hasSdk() ? await bridge.dbList('profiles') : await db.dating_profiles.toArray()
